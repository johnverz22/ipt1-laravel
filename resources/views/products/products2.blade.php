        ...
        <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm"> <img
                    ...
                    <div class="card-body">
                        <div class="clearfix mb-3"> <span class="float-start badge rounded-pill bg-primary">{{$product->getCategory()}}</span> <span class="float-end price-hp">&#8369;{{$product->unitPrice}}/{{$product->unit}}</span> </div>
